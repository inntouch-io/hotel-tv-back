        ...
        <ul class="navbar-nav flex-row order-1 order-lg-2 flex-1 flex-lg-0 justify-content-end align-items-center">
            <li class="nav-item nav-item-dropdown-lg dropdown dropdown-user h-100">
                <a href="#"
                    ...
                    <span
                        class="d-none d-lg-inline-block ml-2">{{ is_null($admin) ? 'Unknown' : $admin->getFullName() }}</span>
                </a>

                <div class="dropdown-menu dropdown-menu-right">
                    <a href="{{ route('admin.profile.edit') }}" class="dropdown-item"><i class="far fa-id-badge"></i>
                        My profile</a>
                    <a href="{{ route('admin.profile.editPassword') }}" class="dropdown-item"><i
                            class="fas fa-key"></i> Сменить пароль</a>
    ...
    <div class="navbar navbar-expand navbar-light px-0 px-lg-3">
        <div class="overflow-auto overflow-lg-visible scrollbar-hidden flex-1">
            <ul class="navbar-nav flex-row text-nowrap">
                ...
                @can('index', \Domain\Welcome\Entities\Welcome::class)
                    <li class="nav-item">
                        <a href="{{ route('admin.welcome.index') }}" class="navbar-nav-link">
