            ...
            <div class="content">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.menus.infos.store', ['menu_id' => $menu->getId()]) }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="locale" id="locale" class="form-control" required>
                                            @foreach(config('app.locales') as $locale => $lang)
                                                @if(!in_array($locale, $menu->infos->pluck('locale')->toArray()))
