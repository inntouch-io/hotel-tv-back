...
/** @var \Domain\Media\Entities\Media $logo */
?>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @else
                            ...
                            <form action="{{ route('admin.media.logo.update') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <p class="font-weight-semibold">Логотип</p>
                                            ...
                                            <div class="border p-3 rounded d-flex align-items-center">
                                                ...
                                                <div style="max-height: 100px; line-height: 100px">
                                                    <img src="{{ asset($logo->getFullPath()) }}" alt="image" id="image" style="max-height: 100px">
                                                </div>
                                            </div>
                                        </div>
