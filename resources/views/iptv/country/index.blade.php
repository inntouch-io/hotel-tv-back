 ...
 * Created: 01.02.2025 / 14:37
 */

/** @var \Domain\Iptv\Entities\IptvCountry $country */
/** @var \Domain\Iptv\Entities\IptvCountryInfo $countryInfo */
?>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($list as $country)
                                            <tr>
                                                <td>
                                                    <div class="font-weight-semibold">{{ $country->getId() }}</div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    @foreach ($country->infos as $countryInfo)
                                                        <li>
                                                            <a href="{{ route('admin.iptv.country.infos.edit', ['id' => $countryInfo->getId()]) }}"
                                                                class="font-weight-semibold">
                                                                [{{ config('app.locales')[$countryInfo->getLocale()] }}] -
                                                                {{ $countryInfo->getTitle() }}
                                                            </a>
                                                        </li>
                                                    @endforeach
                                                </td>
                                                <td>
                                                    <div style="line-height: 60px">
                                                        <img src="{{ asset($country->image->getFullPath()) }}"
                                                            alt="image" style="max-width: 100px">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="badge badge-success">{{ $country->getOrderPosition() }}
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <form
                                                        action="{{ route('admin.iptv.country.destroy', ['id' => $country->getId()]) }}"
