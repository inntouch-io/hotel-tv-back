                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @else
                            ...
                            <form action="{{ route('admin.iptv.channel.update', ['channel' => $channel->getId()]) }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                @method('PUT')
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="title" name="title" class="form-control"
                                                   placeholder="Название" value="{{ $channel->getTitle() }}"
                                                   required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="border p-3 rounded d-flex align-items-center">
                                                ...
                                                <div style="max-height: 100px; line-height: 100px">
                                                    <img src="{{ asset($channel->image->getFullPath()) }}" alt="image" id="image" style="max-height: 100px">
                                                </div>
                                            </div>
                                        </div>
